<?php /* Smarty version Smarty-3.1.19, created on 2014-12-31 13:43:58
         compiled from "/var/www/aae-ensg/templates/bootstrap/plugins.tpl" */ ?>
<?php /*%%SmartyHeaderCode:158282197354a3ef8e440ce9-79517089%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '15c1ce8d19adfeecd5775262d78e1ea868bf8cd9' => 
    array (
      0 => '/var/www/aae-ensg/templates/bootstrap/plugins.tpl',
      1 => 1414243943,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '158282197354a3ef8e440ce9-79517089',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54a3ef8e606165_59718692',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54a3ef8e606165_59718692')) {function content_54a3ef8e606165_59718692($_smarty_tpl) {?><?php if (!is_callable('smarty_function__T')) include '/var/www/aae-ensg/includes/../includes/smarty_plugins/function._T.php';
?>    <table class="listing">
        ...
        <thead>
            <tr>
                ...
                <th class="listing"><?php echo smarty_function__T(array('string'=>"Release date"),$_smarty_tpl);?>
</th>
...
?>
 ...
 (<?php echo $_smarty_tpl->tpl_vars['name']->value;?>
                ...
                <td><?php echo $_smarty_tpl->tpl_vars['plugin']->value['date'];?>
</td>
                <td class="nowrap">
            ...
            var _initdb_bindings = function(res){
                ...
                $("#plugins_initdb_form").submit(function(event) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        data: _dataString,
                        <?php echo $_smarty_tpl->getSubTemplate ("js_loader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
,
