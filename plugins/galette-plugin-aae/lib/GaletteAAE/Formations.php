...
/**
     * Retrieve member from one ing. promotion
     *
     * @param int $StartYear
     *
     * @return array
     */
    public function getIngPromotion($annee_debut)
    {
        global $zdb;
...
/**
     * Retrieve member from one dc promotion
     *
     * @param int $StartYear
     *
     * @return array
     */
    public function getDCPromotion($annee_debut)
    {
        global $zdb;
