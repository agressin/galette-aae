/**
	...
	In: options = {
			...
			keyIGN : string, clé GéoPortail, ex : 3lazvcze0jph9flnl6agpvss (localhost) ou 6hjv98eu0bn2g0puikh3k1ux (192.168.56.101, par défaut)
		}
**/
function CarteMembres(options) {
	...
	/**
		GET CAPABILITIES WMTS IGN : http://wxs.ign.fr/6hjv98eu0bn2g0puikh3k1ux/geoportail/wmts?SERVICE=WMTS&REQUEST=GetCapabilities
	...
	**/
	...
	this.layerIGNzoom = L.tileLayer(urlIGN, {
		//minZoom: 7,
		maxZoom : 18/*,
		bounds : L.latLngBounds([41.283207,1.738281], [46.75984, 9.747314])*/
	}).addTo(this.map);
console.log(L.latLngBounds([41.283207,1.738281], [46.75984, 9.747314]));
